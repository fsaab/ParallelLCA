...
module=Calculators_Aggregated
echo " compiling c++ to:" 
echo $root/$calculatorproject/src/main/c++/Native/$module/libLCAKernel.so

rm $root/$calculatorproject/src/main/c++/Native/$module/libLCAKernel.so
...
mpic++ -pipe  -D_JNI_IMPLEMENTATION_  -m64   -fPIC \
  ...
  -I/usr/lib/jvm/java-8-oracle/include/linux/ \
   -lgsl -lgslcblas -lm -lboost_mpi -lboost_serialization  -shared -o $root/$calculatorproject/src/main/c++/Native/$module/libLCAKernel.so